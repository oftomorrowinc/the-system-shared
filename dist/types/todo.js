...
exports.getTodoStatusCounts =
  exports.isTodoNeedsApproval =
  exports.isTodoPending =
  exports.isTodoComplete =
  exports.TodoSchema =
    void 0;
...
exports.TodoSchema = zod_1.z.object({
  ...
  inputValues: zod_1.z.array(zod_1.z.record(zod_1.z.string(), zod_1.z.any())).optional(),
